...
import os
domain_signature_ec_dic_uniprot_1st=pickle.load(open('domain_signature_ec_dic_1st_pickle','rb'))
domain_signature_ec_dic_uniprot_2nd=pickle.load(open('domain_signature_ec_dic_2nd_pickle','rb'))
domain_signature_ec_dic_uniprot_3rd=pickle.load(open('domain_signature_ec_dic_3rd_pickle','rb'))
domain_signature_ec_dic_uniprot_4th=pickle.load(open('domain_signature_ec_dic_4th_pickle','rb'))
...
specificity=float(os.environ['specificity_threshold'])
...
os.system('cat /dev/null > result_with_specificity_%s.dat'%(name))  # construct the file with which to write the result in
g=open('result_with_specificity_%s.dat'%(name),'r+')
f=open('query.dat','r')
