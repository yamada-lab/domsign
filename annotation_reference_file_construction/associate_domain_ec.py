...
import pickle
pickle.dump(fourth_ds_ec,open('ec_domain_4_pickle','wb'))
pickle.dump(first_ds_ec,open('ec_domain_1_pickle','wb'))
pickle.dump(second_ds_ec,open('ec_domain_2_pickle','wb'))
pickle.dump(third_ds_ec,open('ec_domain_3_pickle','wb'))
