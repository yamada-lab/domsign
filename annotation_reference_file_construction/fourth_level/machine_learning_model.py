...
import pickle
ds_ec_raw_dic=pickle.load(open('ec_domain_4_pickle','rb'))
# data structure
# {ds:[ec1,ec2, ...], ...}
...
print "number of ds-ec pairs for the 4th ec hierarchy level:  ",
print len(domain_signature_ec_dic)
print "number of 100% specific ds-ec pairs for the 4th ec hierarchy level:  ",
print str(specific_number)
pickle.dump(domain_signature_ec_dic,open('domain_signature_ec_dic_4th_pickle','wb'))
