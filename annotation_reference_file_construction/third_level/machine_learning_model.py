...
import pickle
ds_ec_raw_dic=pickle.load(open('ec_domain_3_pickle','rb'))
# data structure
# {ds:[ec1,ec2, ...], ...}
...
print "number of ds-ec pairs for the 3rd ec hierarchy level:  ",
print len(domain_signature_ec_dic)
print "number of 100% specific ds-ec pairs for the 3rd ec hierarchy level:  ",
print str(specific_number)
pickle.dump(domain_signature_ec_dic,open('domain_signature_ec_dic_3rd_pickle','wb'))
